...
CREATE TABLE [dbo].[tokens_recuperacion](
	...
	[fecha_exp] [datetime2](7) NULL,
 CONSTRAINT [PK_tokens_recuperacion] PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[tokens_recuperacion]  WITH CHECK ADD  CONSTRAINT [FK_tokens_usuarios] FOREIGN KEY([id_usuario])
REFERENCES [dbo].[usuarios] ([id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[tokens_recuperacion] CHECK CONSTRAINT [FK_tokens_usuarios]
GO
